...
<body>
	...
	<div class="container-fluid">
		<h1 class="text-right">Update Round</h1>
		<form:form method="post" action="/update/${round.id}" modelAttribute="round">
			<div class="form-group">
				<form:label path="golfCourse">GolfCourse: </form:label>
				<form:errors path="golfCourse"/>
				<form:input path="golfCourse" type="text" value="${round.golfCourse}" class="form-control"/>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<form:select path="tees" value="${round.tees}">
			...
			<div class="form-group">
				...
				<form:select path="holesPlayed" value="${round.holesPlayed}">
			...
			<div class="form-group">
				...
				<form:input type="date" path="roundDate" value="${round.roundDate}" class="form-control"/>
			</div>
			<div class="form-group">
				<form:label path="score">Score: </form:label>
				<form:input path="score"  type="number" class="form-control" value="${round.score}"/>
			</div>	
			<p class="text-left">
		...
		<p>	
			<a href="/delete/round/${round.id}"><button class=" btn btn-secondary">Delete</button></a>
		</p>
	<hr>
	</div>
</body>
